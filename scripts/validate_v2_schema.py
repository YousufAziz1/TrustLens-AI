...
def validate_schema():
    contract_path = os.path.join(os.path.dirname(__file__), "..", "contracts", "TrustLensVerifierV2.py")
    ...
    print("Submitting TrustLensVerifierV2.py to GenLayer Studio RPC for schema validation...")
    try:
